<template>
  <kalendar :configuration="calendar_settings" :appointments="appointments" class="generate-shadow">
    ...
    <div slot="creating-card" slot-scope="{appointment_props}">
      ...
      <span class="time">{{appointment_props.start_value.value}} - {{appointment_props.end_value.value}}</span>
    </div>
    ...
    <div slot="details-card" slot-scope="{appointment_props}">
      ...
      <span class="time">
        {{appointment_props.start_value.value | normalizeDate('hh:mm A')}} - {{appointment_props.end_value.value | normalizeDate('hh:mm A')}}
      </span>
    </div>
...
import "../../../node_modules/kalendar-vue/dist/KalendarVue.css";
  ...
  data() {
    return {
      appointments: [{data : {
        title: "aaaa",
        description: "b"
      }, from: "Wed Jan 30 2019 03:00:00 GMT+0100 (Central European Standard Time)",
      to: "Wed Jan 30 2019 05:00:00 GMT+0100 (Central European Standard Time)",
      date: "2019-01-30" }],
      calendar_settings: {
        style: "material_design", // ['flat_design', 'material_design']
        view_type: "Month", // ['Month', 'Day']
        split_value: 30, // Value % 60 === 0
      ...
      a2 : [{data : {
        title: "aaaa",
        description: "b"
      }, from: "Wed Jan 30 2019 06:00:00 GMT+0100 (Central European Standard Time)",
      to: "Wed Jan 30 2019 07:00:00 GMT+0100 (Central European Standard Time)",
      date: "2019-01-30" },{data : {
        title: "aaaa",
        description: "b"
      }, from: "Wed Jan 30 2019 09:00:00 GMT+0100 (Central European Standard Time)",
      to: "Wed Jan 30 2019 10:00:00 GMT+0100 (Central European Standard Time)",
      date: "2019-01-30" }]
    };
  },
  methods: {
    ...
    completeAppointment(popup_data, form_data) {
      let start = popup_data.appointment_props.start_value.value
